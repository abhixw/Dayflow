    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">A summary of your attendance, leave, and payroll.</p>
        </div>
      ...
      {!isLoading && !isError && data && (
        <>
          ...
          <section className="flex flex-col gap-4">
            ...
            {data.payroll ? (
              <PayrollSummary payroll={data.payroll} />
            ) : (
              <EmptyState message="No payroll information available yet." />
            )}
          </section>
        </>
      )}
